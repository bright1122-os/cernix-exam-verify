...
echo "=== Testing QrTokenService Payload Structure ===\n";

// Simulate QrTokenService payload (lines 60-67 of QrTokenService.php)
$tokenPayload = [
...
echo "QrTokenService payload: " . json_encode($tokenPayload) . "\n";

// Encrypt
$encrypted = $crypto->encryptPayload($tokenPayload, $aesKey, $hmacSecret);
